...
pub(crate) const MILLI_kabocha: Balance = 10u128.pow(12);
pub(crate) const MAX_COLLATOR_STAKE: Balance = 200_000 * 1000 * MILLI_kabocha;
pub(crate) const BLOCKS_PER_ROUND: BlockNumber = 5;
pub(crate) const DECIMALS: Balance = 1000 * MILLI_kabocha;
