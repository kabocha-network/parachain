...
//! ## Overview
//!
//! The kabocha parachain staking pallet provides functions for:
...
pub mod pallet {
	...
	/// kabocha-specific lock for staking rewards.
	pub(crate) const STAKING_ID: LockIdentifier = *b"kabopstk";
	...
	impl<T: Config> Pallet<T> {
		...
		/// 10% max staking rate, 200k kabocha max collator stake and 30 collators:
		/// NetworkRewards = NetworkRewardRate * 10% * 10% * 200_000 kabocha * 30
		///
